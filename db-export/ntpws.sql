...
CREATE TABLE IF NOT EXISTS `countries` (
  ...
  `country_code` varchar(255) COLLATE utf8mb4_croatian_ci NOT NULL,
  `country_name` varchar(255) COLLATE utf8mb4_croatian_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=246 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_croatian_ci;
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `country` varchar(255) COLLATE utf8mb4_croatian_ci NOT NULL,
  `city` varchar(255) COLLATE utf8mb4_croatian_ci NOT NULL,
  `street` varchar(255) COLLATE utf8mb4_croatian_ci NOT NULL,
  `dob` date NOT NULL,
